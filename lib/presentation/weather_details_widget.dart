        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text(
                ...
                style: TextStyle(
                    color: Color.fromARGB(255, 56, 89, 211), fontSize: 72),
              )
            ],
          ),
          SizedBox(
          ...
          Row(
            children: [
              ...
              Text(
                "min temp : " + weatherContoller.getTempMin().string + '°',
                style: TextStyle(color: Color.fromARGB(255, 56, 89, 211)),
              ),
            ],
          ),
          Row(
            children: [
              ...
              Text(
                "max temp : " + weatherContoller.getTempMax().string + '°',
                style: TextStyle(color: Color.fromARGB(255, 56, 89, 211)),
              ),
            ],
          ),
          Row(
            children: [
              ...
              Text(
                "Feels like : " + weatherContoller.getFeelsLike().string + '°',
                style: TextStyle(color: Color.fromARGB(255, 56, 89, 211)),
              ),
            ],
          ),
          Row(
            children: [
              Padding(
                child: Icon(Icons.atm, color: Color.fromARGB(255, 56, 89, 211)),
                padding: EdgeInsets.all(4),
              ),
              Text(
                "pressure : " + weatherContoller.getPressure().string + ' hPa',
                style: TextStyle(color: Color.fromARGB(255, 56, 89, 211)),
              ),
            ],
          ),
          Row(
            children: [
              ...
              Text(
                "Humidity : " + weatherContoller.getHumidity().string + ' %',
                style: TextStyle(color: Color.fromARGB(255, 56, 89, 211)),
              ),
            ],
          ),
